...
class ParseBinPath:
    ...
    def __init__(self, bin_path: t.Union[str, Path], parttool: str = ''):
    ...
    def flash_bin_args(self, baudrate: int = 0) -> t.List[str]:
    ...
    def erase_nvs_args(self, nvs_bin: str = '') -> list[str]:
        ...
        if self.parttool_path and not part_csv.is_file() and part_bin.is_file():
            try:
                ...
                logger.error(f'Failed to parse partition_table: {str(e)}')
